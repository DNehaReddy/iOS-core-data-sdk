...
public class NucleusState {
    ...
    public init(key: String, passableMetadata: [String: Any], fetchPlayheadTime: @escaping () -> Int,
        ...
        self.key = key
        self.metadata = passableMetadata
        ...
        self.data = [
            ...
            "beacon_domain": (passableMetadata["configDomain"] as? String) ?? "metrix.guru",
            "workspace_id": (passableMetadata["workspace_id"] as? String) ?? "workspaceId"
        ]
